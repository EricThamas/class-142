...
def getMovieRecommendation(title,cosine_score): 
    idx= indice[title] 
    ...
    return df["original_title","postlink","runtime","releasedate","vote_average","overview"].iloc[movie_indice].values.tolist()